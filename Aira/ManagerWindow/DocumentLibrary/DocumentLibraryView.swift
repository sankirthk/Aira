...
struct DocumentLibraryView: View {
  ...
  var body: some View {
    ...
    .onDeleteCommand {
      guard bulkSelection.isSelectionMode && deletionIsAvailable else { return }
      deleteConfirmation = .bulk(count: bulkSelection.selectedScriptIDs.count)
    }
    .onAppear {
  ...
  private func scriptCard(for meta: ScriptMeta) -> some View {
    ScriptCardView(
      ...
      selectedCount: bulkSelection.selectedScriptIDs.count,
