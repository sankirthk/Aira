...
final class AiraSparkleUserDriver: NSObject, SPUUserDriver {
  ...
  func showReady(toInstallAndRelaunch reply: @escaping (SPUUserUpdateChoice) -> Void) {
    let fallbackVersion =
      hostBundle.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? "latest"
  ...
  func showUpdateInstalledAndRelaunched(_ relaunched: Bool, acknowledgement: @escaping () -> Void) {
    standardUserDriver.showUpdateInstalledAndRelaunched(
      relaunched, acknowledgement: acknowledgement)
  }
