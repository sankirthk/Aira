  ...
  private var canvasBody: some View {
    Canvas { context, canvasSize in
      ...
      case .script:
        ...
        var scribble = Path()
        scribble.move(to: pt(8, 10))
        scribble.addQuadCurve(to: pt(15.5, 10), control: pt(11.5, 9))
        scribble.move(to: pt(8, 13))
        scribble.addQuadCurve(to: pt(16, 13), control: pt(12, 14))
        scribble.move(to: pt(8, 16))
        scribble.addQuadCurve(to: pt(14, 16), control: pt(11, 15.3))
      ...
      case .star:
        ...
        let pts: [(CGFloat, CGFloat)] = [
          (12, 3), (14, 9), (20, 10), (16, 14), (17, 20), (12, 17), (7, 20), (8, 14), (4, 10),
          (10, 9),
        ]
      ...
      case .recent:
        ...
        var h = Path()
        h.move(to: pt(12, 7))
        h.addLine(to: pt(12, 12))
        h.addLine(to: pt(15.5, 14))
      ...
      case .settings:
        ...
        for spoke in spokes {
          sp.move(to: pt(spoke.0, spoke.1))
          sp.addLine(to: pt(spoke.2, spoke.3))
        }
      ...
      case .sidebar:
        ...
        context.fill(
          Path(roundedRect: rc(3, 5, 6, 14), cornerRadius: 2 * s),
          with: .color(color.opacity(0.3)))
        var dv = Path()
        dv.move(to: pt(9, 5))
        dv.addLine(to: pt(9, 19))
      ...
      case .trash:
        ...
        p.addLine(to: pt(19, 21))
        p.addLine(to: pt(19, 7))
        p.move(to: pt(9, 3))
        p.addLine(to: pt(15, 3))
        p.move(to: pt(3, 7))
      ...
      case .edit:
        ...
        p.addLine(to: pt(3, 20))
        p.addLine(to: pt(5, 14))
        p.closeSubpath()
        p.move(to: pt(15, 6))
