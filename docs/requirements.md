...
- `Cast to Notch` does not start a presenter session when the resolved script body has zero non-whitespace characters; the app keeps the manager visible and shows a lightweight error message.
