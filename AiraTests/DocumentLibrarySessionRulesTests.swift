...
struct DocumentLibrarySessionRulesTests {
    ...
    @Test func bulkSelectionControlsHideDuringActiveSession() {
        #expect(DocumentLibrarySessionRules.showsBulkSelectionControls(sessionActive: false, visibleScriptCount: 3))
        #expect(!DocumentLibrarySessionRules.showsBulkSelectionControls(sessionActive: true, visibleScriptCount: 3))
        #expect(!DocumentLibrarySessionRules.showsBulkSelectionControls(sessionActive: false, visibleScriptCount: 0))
    }
