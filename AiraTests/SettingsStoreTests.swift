...
struct SettingsStoreTests {
    ...
    @Test func saveFollowedByLoadReturnsSameSettings() throws {
        ...
        let settings = AppSettings(
            ...
            pillConfigurations: [
                ...
                PillWindowConfiguration(contentMode: .manual(scriptId: UUID(uuidString: "AAAAAAAA-BBBB-CCCC-DDDD-EEEEEEEEEEEE")!))
            ],
    ...
    @MainActor @Test func appSettingsCodableRoundTrip() throws {
        let settings = AppSettings(
            ...
            maxPillCount: 2,
            pillConfigurations: [
                PillWindowConfiguration(contentMode: .manual(scriptId: UUID(uuidString: "11111111-2222-3333-4444-555555555555")!)),
                PillWindowConfiguration(contentMode: .voiceSync)
            ],
