...
struct AppStateTests {
    ...
    @Test func duplicateScriptInCollectionRefreshesCollectionMembership() throws {
        ...
        let refreshedCollection = try #require(appState.collections.first(where: { $0.id == collection.id }))
    ...
    @Test func initWithCorruptSettingsFallsBackToDefaultsAndPublishesError() throws {
        ...
        #expect(appState.persistenceErrorMessage == SettingsStore.StoreError.corruptData.localizedDescription)
    }
}
